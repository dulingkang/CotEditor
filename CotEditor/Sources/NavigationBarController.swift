...
final class NavigationBarController: NSViewController {
  ...
  @IBOutlet weak var qqNameTextField: NSTextField!
  @IBOutlet weak var qqPasswordTextField: NSSecureTextField!
  @IBOutlet weak var shareKeyField: NSTextField!
...
// MARK: Private method
fileprivate extension NavigationBarController {
  ...
  func updateTextOrientation(to orientation: NSLayoutManager.TextLayoutOrientation) {
  ...
  func initKeys() {
    qqNameTextField.stringValue = KeyManager.shared.name
    qqPasswordTextField.stringValue = KeyManager.shared.password
  ...
  func saveKey() {
    KeyManager.shared.name = qqNameTextField.stringValue
    KeyManager.shared.password = qqPasswordTextField.stringValue
